...
const Header = () => {
    ...
    const themeOptionsRef = useRef(null); // Referência para o menu de opções de tema

    // Função para fechar o menu de opções de tema se clicar fora dele
    ...
    const themeOptions = [
        { id: 1, primaryColor: "rgba(25, 118, 210, 1)", titleColor: "rgba(51, 51, 51, 1)", bodyColor: "rgba(245, 245, 245, 1)", textColor: "#1976d2", containerColor: "rgba(245, 245, 245, 1)" },
                        ...
                        {themeOptions.map((option) => (
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    closeMenus(); // Fecha ambos os menus ao selecionar um tema
                                }}
                            >
